    ...
    <div class="Chat">
        <div class="flex justify-between items-center">
            ...
            <transition name="fade">
                <div v-if="statementVisible"
                    ...
                    <el-input v-model="statementName" placeholder="搜索报表">
                        <template #prefix>
            ...
            <div class="">
                < img class="w-6 h-6 rounded-full border border-gray-300 object-cover aspect-square"
        ...
        <div v-else id="chat-window" class="flex-1 overflow-auto p-20">
            <div v-for="(msg, index) in displayedMessages" :key="index" class="mb-4 flex items-start">
                <div v-if="msg.type === 'user'" class="bg-gray-200 rounded-lg p-3 ml-auto max-w-md">
                    <p class="text-lg text-blue-600">{{ msg.content }}</p>
                </div>
                ...
                <div v-if="msg.type === 'ai'" class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-lg font-bold" style="margin-bottom: 0.5rem;">gpt-3.5-turbo</p>
                        <p class="text-lg text-green-600">{{ msg.content }}</p>
        ...
        <!-- 提问框部分，调整为右边的底部 -->
        <div class="flex justify-between items-center gap-5 mb-3 mx-3 fixed bottom-0 right-0 w-5/6" id="input-area">
