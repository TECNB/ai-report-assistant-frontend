  ...
  <div class="mb-4">
    <div @click="toggleDropdown" :class="{
      ...
      <div class="flex items-center">
        ...
        <span class="font-bold text-w">{{ title }}</span>
      </div>
      ...
      <div v-if="isOpen" class="pl-4 pt-2">
        <div class="flex flex-wrap gap-2">
          <div v-for="(job, index) in jobs" :key="index" @click="toggleJobSelection(job)" :class="{
            ...
            class="px-4 py-2 rounded-lg flex justify-between items-center shadow-sm border border-gray-300 inline-flex cursor-pointer transition-colors duration-300">
            <span>{{ job }}</span>
