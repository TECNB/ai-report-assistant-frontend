        ...
        <div class="DataSidebar bg-white text-black fixed inset-y-0 right-0 w-2/5 z-50 p-6 overflow-y-auto"
            ...
            <div class="header-main">
                ...
                <div class="flex items-center mt-2">
                    ...
                    <button class="bg-gray-800 text-white font-bold py-1 px-5 rounded ml-auto">提问</button>
            ...
            <div class="quick-question mt-6">
                ...
                <div class="question-list flex flex-wrap gap-4 mt-4">
                    <button v-for="(item, index) in quickQuestionsData" :key="index"
            ...
            <div class="tab-selection mt-8 flex items-center">
                <div class="relative inline-block">
                    <!-- 字段预览 -->
                    <button @click="activeTab = 'fieldPreview'" :class="{ 'text-gray-500': activeTab === 'fieldPreview' }"
                ...
                <div class="relative inline-block">
                    <!-- 数据预览 -->
                    <button @click="activeTab = 'dataPreview'" :class="{ 'text-gray-500': activeTab === 'dataPreview' }"
